...
// ExternalViewerURLs is the resolver for the externalViewerURLs field.
func (r *imageResolver) ExternalViewerURLs(ctx context.Context, obj *types.Image) (map[string]any, error) {
	return toMapStringAny(obj.ExternalViewerURLs), nil
}
...
type (
	dynamicDataResolver  struct{ *Resolver }
	imageResolver        struct{ *Resolver }
	imageSummaryResolver struct{ *Resolver }
