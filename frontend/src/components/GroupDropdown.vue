...
<template>
  <div class="hs-dropdown relative inline-flex flex-nowrap items-center [--auto-close:inside]">
    ...
    <!-- Group's types -->
    <div
      class="hs-dropdown-menu duration mt-2 hidden min-w-60 divide-neutral-700 rounded-lg border border-neutral-700 bg-neutral-800 p-2 opacity-0 shadow-md transition-[opacity,margin] before:absolute before:-top-4 before:start-0 before:h-4 before:w-full after:absolute after:-bottom-4 after:start-0 after:h-4 after:w-full hs-dropdown-open:opacity-100"
    >
      <div
